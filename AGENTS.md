...
~/iris/ai.knowledge/rules/livekit-iris-fork/INDEX.md  (if exists)
~/iris/ai.knowledge/knowledge/global/INDEX.md
~/iris/ai.knowledge/knowledge/livekit-iris-fork/INDEX.md  (if exists)
```
...
Agent mistake → `/iris-rule global|livekit-iris-fork {rule}`
Explained something new → `/iris-learn global|livekit-iris-fork {context}`
